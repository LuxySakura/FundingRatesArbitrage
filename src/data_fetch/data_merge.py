...
if __name__ == '__main__':
    ...
    okx_fetch_history_mark_price_candles(symbol=okx_symbol, segments=k_history_segments)
    print("#=========================#\n")

    print("<==== Hyper Liquid History Candles ====>")
    hl_fetch_history_mark_price_candles(ticker, k_history_segments)
    print("#=========================#\n")

    print("<==== Binance History Candles ====>")
    bin_fetch_history_mark_price_candles(bin_symbol, k_history_segments)
    print("#=========================#\n")

    print("<==== Binance History FR ====>")
    bin_fetch_history_funding_rates(symbol=bin_symbol, segments=fr_segments)
    print("#=========================#\n")

    print("<==== OKX History FR ====>")
    okx_fetch_history_funding_rates(symbol=okx_symbol, segments=fr_segments)
    print("#=========================#\n")

    print("<==== Hyper Liquid History FR ====>")
    hl_fetch_history_funding_rates(ticker, fr_segments)
    print("#=========================#\n")